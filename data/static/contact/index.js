// Define Contact Data
const data = {
  website : ["https://connorcode.com", "https://connorcode.com"],
...
Object.keys(data).forEach((key) => {
  ...
  element.innerHTML = `<p>✦ </p><a href="#" class="items" id="${key}">[${key.replace(/_/g, ' ').toUpperCase()}]</a>`;
...
function showData(id, node) {
  ...
  if (userData[1] != undefined)
    element.innerHTML = `➥ <a href="${userData[1]}" class="userDataLink">${userData[0]}</a>`;
